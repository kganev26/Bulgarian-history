...
public void Die()
{
    // Ако загиналата единица е вражеска (Византиец), играчът получава жълтици
    if (factionId == 2 && data != null)
    {
        if (ResourceManager.Instance != null)
        {
            ResourceManager.Instance.AddGold(data.goldReward);
        }
    }

    // Дерегистрация и унищожаване на обекта
    if (ProvinceManager.Instance != null)
    {
